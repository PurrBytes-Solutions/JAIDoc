...
_This section is auto-generated by `scripts/generate-jdk-versions-doc.ps1` (PowerShell) or `scripts/generate-jdk-versions-doc.sh` (bash) — run either to refresh the versions:_
