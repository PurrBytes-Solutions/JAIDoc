...
├── .run/                                                                                     # IntelliJ run configurations (portable across machines)
...
└── src/
    ...
    └── test/
        ...
        │   │   ├── ChunkWriterTest.java                                                      # Chunk generation and output validation
        │   │   └── DocTreeJsonTest.java                                                      # DocTree → JSON conversion and text normalization
        │   ├── model/converter/                                                              # JPA converter tests (FloatArrayConverter)
        │   │   └── FloatArrayConverterTest.java                                              # float[] ↔ SQLite BLOB round-trip
        │   ├── service/                                                                      # Service layer tests (JavaDoc generation, ingest + search)
        │   │   ├── DocumentationServiceTest.java                                             # DocumentationService unit tests (mock-based)
        ...
        │   │   ├── SpringBootArtifactDownloaderTest.java                                     # Spring Boot artifact download from Maven Central (unit)
        │   │   ├── SpringBootArtifactDownloaderIntegrationTest.java                          # Spring Boot artifact download from Maven Central (integration)
        │   │   ├── JdkDistributionDownloaderTest.java                                        # JDK distribution downloader (OS mapping, URL resolution)
        │   │   └── ZIPHelperTest.java                                                        # ZIP entry lookup utility
        │   └── JAIDocTest.java                                                               # Main application startup integration test
        └── resources/
